...
class XetraSourceConfig(NamedTuple):
    """
    Xetra ETL Source Configuration
    src_first_extract_date: date for extracting the source
    src_col_names: list of column names for the source
    src_col_date: column name for the date
    src_col_isin: column name for the isin
    src_col_time: column name for the time
    src_col_start_price: column name for the start price
    src_col_min_price: column name for the minimum price
    src_col_max_price: column name for the maximum price
    src_col_trade_volume: column name for the trade volume
    """
